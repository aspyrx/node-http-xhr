...
//
['on', 'once', 'removeListener', 'emit'].forEach(function (key) {
  Object.defineProperty(NodeHttpXHR.prototype, '_' + key, {
...
Object.defineProperties(
  ...
  /** @lends module:node-http-xhr.prototype */
  {
    ...
    UNSENT: { value: 0 },
    /**
     * Ready state indicating that `open()` has been called, but not `send()`.
     *
     * @type {Number}
     * @default 1
     * @readonly
    ...
    timeout: {
      ...
      set: function setTimeout(timeout) { this._reqOpts.timeout = timeout; }
    },
    /**
...
[
  ...
  */
  ...
  var key = 'on' + type;
  Object.defineProperty(NodeHttpXHR.prototype, key, {
...
NodeHttpXHR.prototype.getResponseHeader = function (name) {
  ...
  return this._resp.headers[name] || null;
};
 ...
 */
NodeHttpXHR.prototype.addEventListener = function (type, listener, options) {
  if (options && options.once) {
    this._once(type, listener);
    return;
  }
 ...
 * @param {Function} listener - The callback.
 */
NodeHttpXHR.prototype.removeEventListener = function (type, listener) {
 ...
 */
NodeHttpXHR.prototype.dispatchEvent = function (event) {
  event.target = this;
